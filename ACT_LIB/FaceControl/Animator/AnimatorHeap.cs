...
namespace Act.Lib.Animator
{
     ...
     */
    public class AnimatorHeap
    {

       // private static readonly ILogger _logger = Log.ForContext("SourceContext", "AnimatorHeap");

        //private static readonly ICounterMeasure numHeapElements = _logger.CountOperation("counter", "HeapElement(s)");
        ...
        public AnimatorHeap()
        {
            ...
            //_logger.Information("Start AnimatorHeap");
            //numHeapElements.Reset();
        }
        ...
        public void Insert(HeapElement el)
        {
            ...
            //_logger.Debug("Insert HeapElement of type "+ el.Task.GetType().Name + " in tasksHeap  ", () => el);
            //numHeapElements.Increment();
        }
         ...
         * @type AnimeTask
         */
        internal TimeSpan RemoveTask(ITask t)
        {
            //long ret = -1;
